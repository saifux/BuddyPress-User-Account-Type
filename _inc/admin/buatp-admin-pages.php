...
class buatp_admin_options {
    ...
    function buatp_set_option_arrays(){
        foreach((array)$this->all_type_info as $val){
            if( isset($this->buatp_profile_data_setting['buatp_exclude_fields_for_'.$val['id']]) && $this->buatp_profile_data_setting['buatp_exclude_fields_for_'.$val['id']])
            $all_excludeds = (array)array_merge( (array)$all_excludeds , $this->buatp_profile_data_setting['buatp_exclude_fields_for_'.$val['id']]);
    ...
    function buatp_basic_setting_page(){
        ...
        if($not_configured) {
            ...
            foreach((array)$this->all_type_info as $val) {
                $i++;
                $slug_list[$i] = array(
                    'name' => 'buatp_slug_selection_for_'.$val['id'],
                    'class' => 'buatp_slug_selection buatp_slug_selection_for_'.$val['id'],
                ...
                $roles_list[$i] = array(
                    'name' => 'buatp_role_selection_for_'.$val['id'],
                    'class' => 'buatp_role_selection_for_'.$val['id'],
    ...
    function buatp_profile_data_setting_page(){
        ...
        foreach((array)$this->all_type_info as $val) {
              ...
              $groupss_list[$j] = array(
                    'name' => 'buatp_exclude_groups_for_'.$val['id'],
                    'class' => 'buatp_exclude_groups_for_'.$val['id'],
              ...
              $fields_list[$j] = array(
                    'name' => 'buatp_exclude_fields_for_'.$val['id'],
                    'class' => 'buatp_exclude_fields_for_'.$val['id'],
              ...
              $fields_list_reg[$j] = array(
                    'name' => 'buatp_include_fields_at_registration_for_'.$val['id'],
                    'class' => 'buatp_include_fields_at_registration_for_'.$val['id'],
    ...
    function buatp_access_setting_page(){
        ...
        foreach((array)$this->all_type_info as $val) {
            $page_restriction[$i++] = array(
                'name' => 'buatp_restrict_page_for_'.$val['id'],
                'class' => 'buatp_restrict_page_for_'.$val['id'],
            ...
            $url_restriction[$i] = array(
                'name' => 'buatp_restrict_url_for_'.$val['id'],
                'class' => 'buatp_restrict_url_for_'.$val['id'],
            ...
            $redirect[$i] = array(
                    'name' => 'buatp_restrict_redirect_for_'.$val['id'],
                    'class' => 'buatp_restrict_redirect_for_'.$val['id'],
